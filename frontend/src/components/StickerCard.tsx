...
import { Copy, Trash2, Eye, Check, ExternalLink, Calendar } from "lucide-react";
...
export default function StickerCard({ sticker, onDelete, index }: StickerCardProps) {
  ...
  return (
    <motion.div
      ...
      className="glass rounded-[2rem] overflow-hidden border border-white/5 group hover:border-primary/30 transition-all duration-500 shadow-xl hover:shadow-primary/5"
    >
      {/* Media Preview */}
        ...
        <div className="flex justify-between items-start">
          <div className="space-y-1">
            <h3 className="text-lg font-bold text-foreground leading-none truncate max-w-[180px]">
              {sticker.caption || "Unnamed Manifest"}
            </h3>
