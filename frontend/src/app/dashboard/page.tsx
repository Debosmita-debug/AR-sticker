...
export default function Dashboard() {
    ...
    return (
        <div className="min-h-screen bg-background text-foreground">
            ...
            <div className="max-w-6xl mx-auto px-6 pt-28 pb-20 mt-4">
                {/* Header */}
                <div className="flex flex-col sm:flex-row items-center justify-between mb-12 gap-6 bg-white/5 p-6 rounded-3xl border border-white/5 backdrop-blur-md">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <Link
                            href="/"
                            className="h-12 px-6 rounded-2xl bg-primary text-primary-foreground font-bold flex items-center gap-2 shadow-lg shadow-primary/20 hover:shadow-primary/40 hover:-translate-y-0.5 transition-all"
                        >
                        ...
                        <button
                            ...
                            className="h-12 w-12 rounded-2xl glass text-muted-foreground hover:text-red-500 hover:bg-red-500/10 flex items-center justify-center transition-all border border-white/5"
                        >
                ...
                <AnimatePresence mode="wait">
                    {tab === "grid" ? (
                        ...
                        >
                            {loading ? (
                                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                                    {[...Array(6)].map((_, i) => (
                                        <div key={i} className="glass rounded-3xl h-72 animate-pulse overflow-hidden bg-white/5" />
                                    ))}
                                </div>
                            ) : stickers.length === 0 ? (
                                <motion.div
                                    ...
                                    animate={{ opacity: 1, scale: 1 }}
                                    className="text-center py-32 glass rounded-[3rem] neon-border mx-auto max-w-2xl px-8"
                                >
                                    ...
                                    <h3 className="text-3xl font-bold">No reality layers found</h3>
                        ...
                        <motion.div
                            ...
                            animate={{ opacity: 1, y: 0 }}
                            exit={{ opacity: 0, y: -10 }}
                            className="glass rounded-[3rem] p-12 neon-border border-white/5"
                        >
                            <div className="text-center py-16 space-y-6">
                                ...
                                <h3 className="text-3xl font-bold">Insights coming soon</h3>
                                ...
                                {stickers.length > 0 && (
                                    <div className="grid grid-cols-3 gap-6 max-w-2xl mx-auto mt-12">
                                        <div className="glass rounded-[2rem] p-8 text-center border border-white/5 hover:border-primary/20 transition-all">
                                        ...
                                        <div className="glass rounded-[2rem] p-8 text-center border border-white/5 hover:border-primary/20 transition-all">
                                            <p className="text-4xl font-black text-foreground">{stickers.length}</p>
